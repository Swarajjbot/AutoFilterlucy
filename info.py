...
OWNER_ID = environ.get('OWNER_ID', '1967990132')
...
AI_LOGS = int(environ.get("AI_LOGS", "-1001975644381")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
BOT_USERNAME = environ.get("BOT_USERNAME", "IdrPremiumMoviebot")
BOT_NAME = environ.get("BOT_NAME", "IDR")
BOT_ID = environ.get("BOT_ID", "7047795447")
S_GROUP = environ.get('S_GROUP', "INDORECINEMAS5")
S_CHANNEL = environ.get('S_CHANNEL', "INDORECINEMAS5")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : INDORE CINEMAS')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001975644381')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+cFYZKXDQ8vQ3YjE1') #Support group link ( make sure bot is admin )
